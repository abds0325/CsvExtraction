...
public class CsvFileExtractionDemoApplication implements CommandLineRunner {

	@Autowired
	EmployeeRepository employeeRepository;

	public static void main(String[] args) {
		SpringApplication.run(CsvFileExtractionDemoApplication.class, args);
	}
